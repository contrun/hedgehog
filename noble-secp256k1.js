      ...
      2: [
        function (require, module, exports) {
          ...
          class JacobianPoint {
            ...
            add(other) {
              if (!(other instanceof JacobianPoint)) {
                throw new TypeError(
                  "JacobianPoint#add: expected JacobianPoint"
                );
              }
              const X1 = this.x;
              const Y1 = this.y;
            ...
            wNAF(n, affinePoint) {
              ...
              let precomputes =
                affinePoint && pointPrecomputes.get(affinePoint);
              if (!precomputes) {
          ...
          class Point {
            ...
            static fromSignature(msgHash, signature, recovery) {
              ...
              if (recovery !== 0 && recovery !== 1) {
                throw new Error(
                  "Cannot recover signature: invalid yParity bit"
                );
              }
          ...
          function verify(signature, msgHash, publicKey) {
            ...
            const pubKey = JacobianPoint.fromAffine(
          ...
          async function schnorrSign(
            ...
            if (msgHash == null)
              throw new TypeError(
                `sign: Expected valid message, not "${msgHash}"`
              );
            ...
            const isValid = await schnorrVerify(
              sig.toRawBytes(),
              m,
              P.toRawX()
            );
          ...
          async function schnorrVerify(signature, msgHash, publicKey) {
            ...
            const m =
              typeof msgHash === "string" ? hexToBytes(msgHash) : msgHash;
